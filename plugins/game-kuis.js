...
global.kuis = [
'¿Qué jugador de fútbol pesa 3 kg?',
'¿Un cantante extranjero al que le gustan las bicicletas?', 
'¿La cantante cuyo cabello no es lacio?', 
'¿Cantantes extranjeros nativos de Indonesia?', 
'¿Cantantes extranjeros que son difíciles de tragar?', 
'¿Un cantante que a menudo es tímido?', 
'¿A qué gobernador le gusta cantar?', 
'¿El vicepresidente que suele ver streaming?', 
'¿Por qué la moto se detiene en un semáforo en rojo?', 
'¿Adivina qué animal es bueno para nadar?', 
'¿Por qué se ponen piedras en las vías del tren?', 
'Está nublado. Hay 5 personas pero solo hay 1 paraguas. ¿Cómo evitas que les llueva encima?', 
'¿Qué tipo de pollo es molesto?', 
'¿Por qué la computadora dice ENTER?', 
'¿Qué tecla puede hacer bailar a la gente?', 
'¿Qué cosita puede noquear a la gente?', 
'Aprende mandarín, piso mojado, ¿qué significa?', 
'¿Qué tipo de pulga es tan terrible?', 
'¿De qué color es el viento?', 
'¿Qué cosa sale cuando se gira?', 
'¿Qué noche fue tan terrible y aterradora?', 
'Alguien estaba buscando algo, salió limpio y volvió a casa maltratado. ¿Qué está buscando realmente?', 
'¿Traducir al japonés sin dinero?', 
'¿Qué tipo de cosa tiene la primera letra K y la parte de atrás es L. Si tiras con fuerza, cojeará cuando la sueltes?', 
'¿Por qué los coches y las motos se detienen cuando el semáforo está en rojo?', 
'¿Muchas personas evitan a pesar de que su piel es blanca?', 
'¿Cuál es la razón por la que los ninjas usan tela para cubrirse la cabeza?', 
'¿Cuál es la razón por la cual se debe cortar el cocotero frente a la casa?', 
'Si se duerme, entonces se despierta. ¿Cuando se despierta, se duerme?', 
'¿Qué enfermedad les encanta cuidar a los humanos?', 
'¿Qué mono es el más molesto?', 
'¿Cuál es la diferencia entre tú y una pintura?', 
'¿Cuál es la diferencia entre las 12:00 y tú?', 
'¿Qué autobús es el más feliz?', 
'¿Qué diablo es el más romántico?', 
'¿Qué lagarto puede hacerme morir?', 
'¿Qué café es el más amargo?', 
'¿Qué barandilla duele más?', 
'¿Qué polo es delicioso?', 
'¿Sabes por qué la Torre Inclinada de Pisa?',
'¿Qué leche es hermosa?', 
'¿Qué significa viernes?', 
'¿Qué nubes te hacen feliz?', 
'¿Cuál es la fruta más rica?', 
'¿Qué es un bocadillo?', 
'¿Qué fue primero con el pollo?', 
'¿Qué fue primero con el pollo?', 
'¿Qué fue primero con el pollo?', 
'La tiró al piso pero la que le dio en la nariz, ¿qué fue eso?', 
'¿Qué ejército es el más pequeño?', 
'¿Qué tienen en común el dinero y los secretos?', 
'¿Cuál es la diferencia entre el sol y la luna?', 
'¿Qué dice en japonés que me recogieron?', 
'¿Un armario que pueda caber en un bolsillo?', 
'¿Qué pato sigue girando a izquierda y derecha?', 
'Hay cinco pollos, multiplicado por dos. ¿Cuánto es el total?', 
'Si tan solo hubiera una escuela que contuviera todo tipo de animales, ¿quién llegaba tarde a menudo?', 
'Millones de pies si giras a la izquierda, ¿cuántos pies?', 
'Cerrado como un palo, abierto en una tienda. ¿Que es eso?', 
'¿Qué persona nada pero nunca se moja el pelo?', 
'Si un elefante se convierte en pollo, luego un león se convierte en pollo, y una cabra se convierte en pollo, entonces, ¿qué es un pollo?'
'¿Cuál es la diferencia entre acción y demostración?', 
'¿Cuál es la quinta letra del alfabeto?', 
'Avión estrellado, barco hundido, ¿dónde apareció?', 
'¿Cuál es la diferencia entre zapatos y jengkol?', 
'¿Qué pesa más, 100 kg de algodón o 100 kg de hierro?', 
'¿Qué hay en medio del campo de arroz?', 
]
